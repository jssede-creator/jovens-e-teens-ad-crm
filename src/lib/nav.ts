        ...
        filhos: [
          {
            rota: "/novosprojetos",
            rotulo: "Quadro",
            descricao: "Projetos por coluna, da ideia à entrega.",
            icone: KanbanSquare,
            permissao: modulo("projetos"),
          },
          {
            rota: "/novosprojetos/tarefas",
            rotulo: "Tarefas",
            descricao: "O que cada projeto precisa, por fase e responsável.",
            icone: ListChecks,
            permissao: modulo("projetos"),
          },
          {
            rota: "/novosprojetos/cronograma",
            rotulo: "Cronograma",
            descricao: "Linha do tempo das fases de cada projeto.",
            icone: CalendarRange,
            permissao: modulo("projetos"),
          },
        ],
